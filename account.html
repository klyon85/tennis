...
<div class="content">  
  ...
  <form class="registration" action="usercake/test.php" method="post">
  	<label>Name: </label><input type="text" name="name" id="name" readonly/><br />
	...
	Retype your new account password:<br />
